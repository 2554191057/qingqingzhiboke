...
(function () {
  ...
  var CSS = [
    ...
    '/* 右下角悬浮按钮 */',
    '.qw-launcher{position:fixed;z-index:45;right:22px;bottom:22px;display:flex;gap:9px;align-items:center;border:1px solid var(--jp-accent);padding:12px 17px;background:var(--jp-surface);border-radius:10px;box-shadow:0 0 30px var(--jp-glow),0 8px 24px rgba(0,0,0,.18);font-size:12px;color:var(--jp-accent);cursor:pointer;transition:transform .2s ease,box-shadow .2s ease;backdrop-filter:blur(12px);-webkit-backdrop-filter:blur(12px);}',
    ...
    '.qw-panel{width:460px;max-width:100%;max-height:calc(100dvh - 40px);display:flex;flex-direction:column;background:var(--jp-surface);border:1px solid var(--jp-line);border-radius:18px;box-shadow:0 28px 100px rgba(0,0,0,.4),0 0 40px var(--jp-glow);overflow:hidden;color:var(--jp-ink);animation:qwPop .3s cubic-bezier(.16,1,.3,1);}',
    ...
    '.qw-body{padding:0 20px 18px;overflow-y:auto;}',
    '/* ===== Twikoo → qiguangji 覆盖 ===== */',
    '.qw-body #tcomment{--twikoo-bg:transparent;--twikoo-theme-bg:transparent;}',
    '.qw-body #twikoo{background:transparent!important;}',
    '.qw-body #twikoo .tk-comments{background:transparent!important;}',
    '.qw-body #twikoo .tk-comments-container{max-height:290px;overflow-y:auto;padding:10px 0 12px;background:transparent!important;overscroll-behavior:contain;}',
    '.qw-body #twikoo .tk-comments-container::-webkit-scrollbar{width:5px;}',
    '.qw-body #twikoo .tk-comments-container::-webkit-scrollbar-thumb{background:var(--jp-line);border-radius:3px;}',
    '.qw-body #twikoo .tk-submit{background:transparent!important;padding:14px 0 0;border-top:1px solid var(--jp-line);}',
    ...
    '.qw-body #twikoo .tk-comment{display:flex!important;align-items:flex-start!important;gap:10px!important;margin-bottom:18px!important;padding:0!important;}',
    '.qw-body #twikoo .tk-comment .tk-avatar{width:29px!important;height:29px!important;border-radius:8px!important;overflow:hidden!important;flex-shrink:0;margin:0!important;}',
    '.qw-body #twikoo .tk-comment .tk-avatar img{width:100%!important;height:100%!important;object-fit:cover!important;}',
    '.qw-body #twikoo .tk-comment .tk-main{min-width:0!important;max-width:calc(100% - 40px)!important;padding:0!important;}',
    '.qw-body #twikoo .tk-comment .tk-row{display:block!important;margin:0 0 7px!important;}',
    '.qw-body #twikoo .tk-meta{display:flex;align-items:center;gap:12px;font-size:10px!important;color:var(--jp-muted)!important;}',
    '.qw-body #twikoo .tk-nick strong{color:var(--jp-accent)!important;font-weight:650!important;font-size:11px!important;}',
    '.qw-body #twikoo .tk-time time{font-size:9px!important;color:var(--jp-muted)!important;}',
    '.qw-body #twikoo .tk-action{margin-left:auto!important;display:flex!important;gap:8px!important;}',
    '.qw-body #twikoo .tk-action .tk-action-link{color:var(--jp-muted)!important;font-size:9px!important;padding:0!important;}',
    '.qw-body #twikoo .tk-action-icon svg{width:11px!important;height:11px!important;}',
    '.qw-body #twikoo .tk-content{white-space:pre-wrap;overflow-wrap:anywhere;padding:10px 12px!important;background:var(--jp-glow)!important;border:1px solid var(--jp-line)!important;border-radius:0 10px 10px 10px!important;font-size:12px!important;line-height:1.7!important;margin:0!important;}',
    ...
    '.qw-body #twikoo .tk-children{margin-left:39px!important;padding-left:0!important;}',
    ...
    '@media(max-width:640px){.qw-launcher{right:14px;bottom:16px;padding:11px 14px;}.qw-backdrop{padding:12px;}.qw-panel{max-height:calc(100dvh - 24px);border-radius:16px;}.qw-panel>header{padding:15px 16px;}.qw-body{padding:0 15px 14px;}.qw-notice{padding:10px 16px;font-size:9px;}.qw-body #twikoo .tk-comments-container{max-height:240px;}}',
