...
'<div class="qw-resize-handle" id="qw-resize-handle"></div>' +
  ...
  var isPad = /iPad|Tablet/i.test(s) || /SM-T[0-9]|TB[0-9]{4}|KF[A-Z]{1,2}|M(?:2105|2106|2206|2208|2217|2304)|2304[0-9]RP|23078KB|(?:DBR|DBY|AGS|BAH|BTV|JDN|KOB|JKM|WGR|DBT|AGM|BDT|HEY)-W/i.test(s) || (/Android/.test(s) && !/Mobile/i.test(s));
