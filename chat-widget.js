...
'.qw-body{padding:0 20px 18px;overflow:hidden;display:flex;flex-direction:column;flex:1;min-height:0;}',
    ...
    '.qw-log-item .qw-log-copy,.qw-admin-item .qw-log-copy,.qw-mgmt-item .qw-log-copy{margin-left:4px;padding:0;font-size:10px;line-height:1.6;border:none;border-radius:0;background:none;color:var(--jp-muted);cursor:pointer;vertical-align:1px;text-decoration:underline dotted;text-underline-offset:2px;}',
    '.qw-log-item .qw-log-copy:hover,.qw-admin-item .qw-log-copy:hover,.qw-mgmt-item .qw-log-copy:hover{color:var(--jp-accent);background:none;text-decoration:underline solid;}',
    '.qw-log-item .qw-log-copy.ok,.qw-admin-item .qw-log-copy.ok,.qw-mgmt-item .qw-log-copy.ok{color:#34d399;text-decoration:none;}',
