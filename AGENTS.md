...
- 公网入口为 `yanzheng.html`（图形验证码，验证通过跳 boke.html）；主域名 `https://qqzttkx.ficp.fun/` 当前绑定资源 `1789524826070699048`（临时域名 https://hg0509.gicp.fun，已线上验证含看板娘集成与栖光集日间样式）。
- 旧资源链（每代删旧绑新）：…→ fasjcm(1789522511554757033，已删) → ms68es(1789523619728216743，已删) → hg0509(1789524826070699048，当前)。
