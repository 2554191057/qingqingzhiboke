...
- 公网入口为 `yanzheng.html`（图形验证码，验证通过跳 boke.html）；主域名 `https://qqzttkx.ficp.fun/` 当前绑定资源 `1789525694603483922`（临时域名 https://rz6zho.gicp.fun，已线上验证含看板娘集成、栖光集日间样式与顶栏）。
- 旧资源链（每代删旧绑新）：…→ ms68es(1789523619728216743，已删) → hg0509(1789524826070699048，已删) → rz6zho(1789525694603483922，当前)。
