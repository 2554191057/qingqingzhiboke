...
(function () {
  ...
  const BLOG_POSTS_MORE = [
    ...
    },
    {
      ...
      date: '2026-08-24',
      readTime: '5分钟',
      excerpt: '桌面上只留水杯、本子和笔，其余全收进抽屉。整理桌面三年后我发现：可见的越少，心里的噪音也越少。',
      icon: '🖥️',
      coverClass: 'blog-cover-3',
      url: '#',
      type: 'article',
      content: `
        <h2>我的桌面整理哲学：少即是多</h2>
        <p>我有一张用了五年的桌子。深胡桃木色，不大，勉强放下一台笔记本、一杯水和一本笔记本。这张桌子见证了我从学生到职场的转变，也见证了我对"空间"这件事的理解是如何一步步改变的。</p>
        <h3>从杂乱到极简的转变</h3>
        <p>刚工作那会儿，我的桌面是这样的：显示器旁边堆着三四本正在看的书、便签纸贴了半台显示器、水杯有两个（一个装茶一个装咖啡）、还有各种数据线和充电头散落在角落。每次坐下来工作，光是整理这些东西就要花十分钟。</p>
        <p>真正的改变发生在三年前。那年我读到一本书，里面提到"可见的东西会消耗心智资源"。作者说，每一件你视线内的物品，都会在潜意识里占据你的注意力份额。我决定做一个实验：把桌面清空，只留最必要的东西。</p>
        <h3>我的极简桌面清单</h3>
        <ul>
          <li>一台笔记本电脑（外接显示器收进柜子里）</li>
          <li>一个玻璃杯（喝水用，喝茶就等喝完再洗）</li>
          <li>一本笔记本 + 一支笔（记录想法用）</li>
          <li>一个笔筒（里面只有两支笔和一把剪刀）</li>
          <li>一盏台灯（调光的，晚上用）</li>
        </ul>
        <p>就这些。其他的东西——书、便签、充电线、零食、护手霜——全部收进抽屉或旁边的置物架上。</p>
        <h3>意外的收获</h3>
        <p>我以为桌面整理带来的好处只是"看起来干净"，但实际上远比这深刻：</p>
        <h3>1. 注意力更集中</h3>
        <p>干净的桌面像一个空白的画布，大脑更容易进入状态。以前写代码时总被便签上的待办事项分散注意力，现在这些都被收起来了，专注力明显提升。</p>
        <h3>2. 决策成本降低</h3>
        <p>以前每次想喝水都要犹豫用哪个杯子，现在只有一个选择。这种"无需决策"的体验延伸到了工作中——当选择变少，行动就变快。</p>
        <h3>3. 心情变好</h3>
        <p>这是最意外的收获。干净的桌面会让我莫名地感到"一切尽在掌握"。或许这就是物理环境对心理状态的影响吧：外在有序，内在也会跟着有序。</p>
        <h3>我的整理原则</h3>
        <p>经过三年的摸索，我总结了几条自己的桌面整理原则：</p>
        <ol>
          <li><strong>一平米原则</strong>：常用物品控制在一平米桌面范围内，超出就收起来</li>
          <li><strong>同类只留一件</strong>：水杯一个、笔一支、本子一本，多了就是浪费</li>
          <li><strong>用完归位</strong>：每使用完一样东西，立刻放回原位，不允许"先放着等会儿再收"</li>
          <li><strong>定期清零</strong>：每周五下班前花三分钟检查桌面，把不属于桌面的东西归位</li>
        </ol>
        <h3>这不是洁癖，是对空间的尊重</h3>
        <p>有人说我这是有洁癖。其实不然。我也会在桌上吃泡面，也会偶尔摊开一堆资料做方案。关键不在于"永远整洁"，而在于"知道什么该在这里，什么不该"。</p>
        <p>桌面空间，其实就是内心空间的映射。当桌面上堆满了东西，内心也会被各种琐事占据。而当我学会给桌面"留白"，我也学会了给自己的生活留白——留出思考的空间，留出休息的空间，留出什么都不做的空间。</p>
        <h3>如果你也想试试</h3>
        <p>不需要像我这样极端。你可以从最简单的开始：<strong>现在就起身，把桌面上不常用的东西收进抽屉。</strong></p>
        <p>就一分钟。你会发现，仅仅是这个小动作，就能让你感觉"清爽"了一些。而这种感觉，就是改变的开始。</p>
        <p>记住：<strong>少即是多。桌面空一点，心就宽一点。</strong></p>
      `,
      cta: '阅读全文',
